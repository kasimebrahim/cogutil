...
SET(PYTHON_SUPPORTED_VALUE_LIST "FloatValue" "StringValue" "LinkValue")

FILE(WRITE "${HEADER_FILE}" "/* File automatically generated by the macro OPENCOG_ADD_ATOM_TYPES. Do not edit */\n")
FOREACH(h_inc_file ${HEADER_INCLUDES})
    FILE(APPEND "${HEADER_FILE}" "#include <${h_inc_file}>\n")
ENDFOREACH(inc_file)
...
FOREACH(d_inc_file ${DEFINITIONS_INCLUDES})
    FILE(APPEND "${DEFINITIONS_FILE}" "#include <${d_inc_file}>\n")
ENDFOREACH(d_inc_file)
